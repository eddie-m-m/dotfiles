...
- Added a report to list vulnerable library versions from the manifest file. [Issue [#53](https://github.com/filllabs/dependi/issues/53)](https://github.com/filllabs/dependi/issues/53)
