...
exports.PhpFetcher = void 0;
const API = __importStar(require("../../api/index/php-index-server"));
...
class PhpFetcher extends fetcher_1.Fetcher {
    ...
    async vulns(dependencies) {
        ...
        const packageVulns = await (0, vulnerability_service_1.queryMultiplePackageVulns)(dependencies, "Packagist");
        return packageVulns;
    }
    checkPreRelease(version) {
        if (!config_1.Settings.php.ignoreUnstable)
            return false;
...
exports.PhpFetcher = PhpFetcher;
//# sourceMappingURL=PhpFetcher.js.map