...
exports.GoProxyFetcher = void 0;
const API = __importStar(require("../../api/index/go-proxy-server"));
...
class GoProxyFetcher extends fetcher_1.Fetcher {
    ...
    transformServerResponse(versions, indexServerURL) {
        ...
        return async function (item) {
            return versions(item.key, indexServerURL).then((mod) => {
    ...
    async vulns(dependencies) {
        ...
        const packageVulns = await (0, vulnerability_service_1.queryMultiplePackageVulns)(dependencies, "Go");
        return packageVulns;
    }
    checkPreRelease(version) {
        if (!config_1.Settings.go.ignoreUnstable)
            return false;
...
exports.GoProxyFetcher = GoProxyFetcher;
//# sourceMappingURL=GoProxyFetcher.js.map