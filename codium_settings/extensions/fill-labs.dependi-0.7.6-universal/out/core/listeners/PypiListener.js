...
exports.fetchedDepsMap = exports.fetchedDeps = exports.dependencies = exports.PypiListener = void 0;
    ...
    async parseAndDecorate(editor) {
        try {
            ...
            if (!fetchedDeps || !fetchedDepsMap) {
                ...
                (0, decorator_1.default)(editor, fetchedDeps, Language_1.Language.Python);
                if (config_1.Settings.vulnerability.enabled) {
                    const vulnData = await this.fetcher.vulns(fetchedDeps);
                    fetchedVulns = await vulnData;
                    (0, decorator_1.default)(editor, fetchedVulns, Language_1.Language.Python);
                }
            }
        }
        catch (e) {
...
exports.PypiListener = PypiListener;
var dependencies;
var fetchedDeps;
var fetchedVulns;
var fetchedDepsMap;
//# sourceMappingURL=PypiListener.js.map