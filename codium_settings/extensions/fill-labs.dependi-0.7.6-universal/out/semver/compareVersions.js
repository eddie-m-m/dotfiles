...
function split(v) {
    ...
    const patchIndex = Language_1.CurrentLanguage === Language_1.Language.Python ? lastIndexOrEnd(c, '.') : indexOrEnd(c, "-");
...
function compareVersions(v1, v2) {
    ...
    if (sp1 && sp2) {
        ...
        for (let i = 0; i < maxLimit; i++) {
            console.log("DEFAULT p1: " + sp1 + " sp2: " + sp2);
            if (p1[i] === undefined ||
    ...
    console.log("v1: " + v1 + " v2: " + v2 + " are equal");
    return 0;
}
